...
export default class Editor extends Component {
    ...
    async save() {
        ...
        await axios
            ...
            .then(() => this.showNotifications('Success', 'success'))
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm("Are you sure want to restore the page from this backup?? All unsaved data will be lost!", {labels: {ok: 'Restore', cancel: 'Cancel'}})
        .then(() => {
            this.isLoading();
            return axios
        ...
        return (
            <>
                ...
                <ConfirmModal 
                    ...
                    text={{
                        title: "Exit",
                        descr: "Are you really want to Exit ?",
                        btn: "Logout"
                    }}/>
